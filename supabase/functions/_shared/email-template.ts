        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="max-width: 600px; margin: 0 auto; background-color: transparent;">
          ...
          <tr>
            <td style="background-color: #dc2626 !important; padding: 40px; text-align: center;">
              <div style="font-family: 'Tanker', 'Impact', 'Arial Black', 'Franklin Gothic Bold', 'Helvetica Bold', sans-serif; font-size: 32px; color: white !important; margin: 0 0 16px 0; font-weight: 400; text-align: center;">LILLA IMPROTEATERN</div>
