-- Create function to delete participant from course table
...
-- Create function to add participant to course table
...
BEGIN
  ...
  -- Insert the participant (will be validated by existing triggers)
  EXECUTE format('
