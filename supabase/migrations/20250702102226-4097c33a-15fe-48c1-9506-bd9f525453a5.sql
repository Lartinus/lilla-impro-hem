...
-- Fix the create_course_booking_table function to properly escape the regex pattern
...
BEGIN
  EXECUTE format('
    CREATE TABLE IF NOT EXISTS public.%I (
      ...
      email TEXT NOT NULL CHECK (email ~* $regex$^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,}$$regex$),
      address TEXT,
      postal_code TEXT,
      city TEXT,
      message TEXT,
