-- Update the get_course_booking_count function to handle the new table
    ...
    SELECT CASE 
        WHEN EXISTS (
            ...
            CASE table_name
                ...
                WHEN 'course_niv__1_1752147042033' THEN 
                    (SELECT COUNT(*)::integer FROM public.course_niv__1_1752147042033)
                ELSE 0
            END
        )
        ELSE 0
