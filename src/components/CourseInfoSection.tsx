        ...
        <div>
          <div className="space-y-4">
            ...
            <ul className="list-none pl-0 space-y-2">
              ...
              <li className="flex items-center space-x-3"><div className="w-2 h-2 bg-blue-600 rounded-full flex-shrink-0"></div><span>Söker en trygg, tydlig och inspirerande plats att växa på</span></li>
            </ul>
            <p>
            ...
            <ul className="list-none pl-0 space-y-2">
              ...
              <li className="flex items-center space-x-3"><div className="w-2 h-2 bg-blue-600 rounded-full flex-shrink-0"></div><span>Och få scentid. Massor.</span></li>
            </ul>
          </div>
        </div>
