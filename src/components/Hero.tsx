...
const Hero = () => {
  ...
  return <section className="min-h-screen flex flex-col justify-center px-0.5 relative overflow-hidden py-0 md:px-0">
      {/* På mobil: mt-12, på desktop: mt-20 för mer avstånd till header */}
      <div className=" mt-12 md:mt-20\n  p-4 md:p-12 lg:p-16\n  text-left space-y-4\n  bg-white\n  max-w-5xl mx-auto\n  px-[52px] py-[27px] my-0">
        
        {/* Beskrivning */}
        <div className="max-w-4xl space-y-2 pb-1">
          <h1 className="sm:text-2xl md:text-3xl leading-tight text-gray-800 tracking-normal mb-4 text-left font-bold text-xl py-px mx-[2px] my-[10px] lg:text-3xl">
