  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 bg-primary-red text-primary-foreground">
      ...
      <div className="container mx-auto px-6 lg:px-8 flex items-center justify-between h-[85px]">
        ...
        <Link
          to="/"
          className="hidden md:block group relative w-14 h-14 overflow-visible transition-transform duration-200 ease-out hover:animate-spin-360"
        >
          <img 
            src="/Favicon1.svg" 
            alt="LIT Logo" 
          ...
          <img 
            src="/Favicon2.svg" 
            alt="LIT Logo Hover" 
            className="w-[52px] h-[52px] absolute top-[-4px] left-[-5px] opacity-0 transition-opacity duration-300 group-hover:opacity-100"
          />
        </Link>
