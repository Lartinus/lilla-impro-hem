      ...
      <div className="container mx-auto px-6 lg:px-8 flex items-center justify-between h-[85px]">
        ...
        >
          <OptimizedImage 
            ...
            alt="LIT Logo" 
            className="w-10 h-10 absolute top-[0px] left-0 transition-opacity duration-300 group-hover:opacity-0"
            priority={true}
            sizes="32px"
          />
          <OptimizedImage 
            ...
            alt="LIT Logo Hover" 
            className="w-10 h-10 absolute top-[0px] left-0 opacity-0 transition-opacity duration-300 group-hover:opacity-100"
            priority={true}
            sizes="32px"
          />
        </Link>
