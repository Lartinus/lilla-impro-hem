      ...
      <div className="container mx-auto px-6 lg:px-8 flex items-center justify-between h-[85px]">
        ...
        >
          <OptimizedImage 
            src="/Logo1.svg" 
            alt="LIT Logo" 
            className="w-8 h-8 absolute top-0 left-0 transition-opacity duration-300 group-hover:opacity-0"
            priority={true}
            sizes="32px"
          />
          <OptimizedImage 
            src="/Logo2.svg" 
            alt="LIT Logo Hover" 
            className="w-8 h-8 absolute -top-6 left-0 opacity-0 transition-opacity duration-300 group-hover:opacity-100"
            priority={true}
            sizes="32px"
          />
        </Link>
