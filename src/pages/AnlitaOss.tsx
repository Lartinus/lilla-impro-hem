  ...
  return (
    ...
    >
      ...
      <main
        ...
        style={{ marginTop }}
      >
        <div className="mx-3 md:mx-auto md:max-w-6xl">
          <div className="grid md:grid-cols-2 gap-6">
            
            {/* Första kortet */}
            <div className="bg-white shadow-xl p-6 md:p-8 lg:p-12 space-y-6">
              <div className="space-y-4">
                <h2>Roligare än quiz. Mer minnesvärt än mingel.</h2>
                <p>
