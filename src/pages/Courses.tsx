  ...
  const courses = [
    {
      ...
      courseLeader: courseLeaders[1], // Hjalmar
      available: true,
      showButton: true
    },
    {
      ...
      courseLeader: courseLeaders[0], // Ellen
      available: true,
      showButton: true
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-theatre-primary via-theatre-secondary to-theatre-tertiary text-theatre-light font-satoshi animate-fade-in">
      ...
      <section className="py-8 px-0.5 md:px-4">
        <div className="space-y-8 border-4 border-white p-6 md:p-6 lg:p-12 bg-white rounded-none mx-3 md:mx-0 md:max-w-3xl md:mx-auto">
          <div className="text-left">
            ...
            <div className="space-y-6 text-gray-700 leading-relaxed">
              ...
              <div className="bg-red-700 text-white p-4 md:p-6 border-4 border-white rounded-none -mx-3 md:-mx-6 lg:-mx-12 md:mx-6 lg:mx-12">
                ...
                <p className="leading-relaxed text-base" style={{ lineHeight: '1.4' }}>
          ...
          <div className="text-left">
            ...
            <div className="space-y-3 mb-6">
              {whoCanCome.map((item, index) => (
                <div key={index} className="flex items-start space-x-3">
                  ...
                  <p className="text-base text-gray-700" style={{ lineHeight: '1.4' }}>{item}</p>
                </div>
              ))}
            </div>
            <p className="text-gray-700 leading-relaxed mb-6 text-base" style={{ lineHeight: '1.4' }}>
            ...
            <div className="space-y-3">
              {benefits.map((benefit, index) => (
                <div key={index} className="flex items-start space-x-3">
                  <span className="text-blue-500 text-sm font-bold flex-shrink-0" style={{ marginTop: '2px' }}>→</span>
                  <p className="text-base text-gray-700" style={{ lineHeight: '1.4' }}>{benefit}</p>
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="space-y-1">
              {faq.map((item, index) => (
                <div key={index} className="bg-theatre-light/10 border-4 border-white px-0 py-2 rounded-none">
                  ...
                  <p className="text-gray-700 leading-relaxed text-base" style={{ lineHeight: '1.4' }}>
                    {item.answer}
                  </p>
                </div>
              ))}
