...
const About: React.FC = () => {
  ...
  return (
    <div
      className="min-h-screen flex flex-col bg-gradient-to-br from-theatre-primary via-theatre-secondary to-theatre-tertiary text-theatre-light relative overflow-x-hidden overflow-y-visible"
    >
      <Header />
      <SimpleParallaxHero imageSrc="/lovable-uploads/0dab5207-02ae-4f61-96e5-de85a5a8d3ad.png" />

      <section
        className="py-8 px-0.5 md:px-4 mt-0 flex-1 relative z-10"
        ...
        <div className="space-y-8 border-4 border-white p-6 md:p-6 lg:p-12 bg-white rounded-none mx-3 md:mx-0 md:max-w-4xl md:mx-auto">
          {/* Om oss-info */}
            ...
            <p className="text-left">
              Lilla Improteatern drivs av tre personer med en gemensam kärlek
              till Improv Comedy – och en stark vilja att skapa en plats där
              både skratten, hantverket och gemenskapen får stå i centrum. Vi
              kommer från olika håll men möttes i impron och i viljan att
              bygga något nytt tillsammans.
            </p>
          </div>
