...
const performers = [{
  ...
  image: "/lovable-uploads/626ba92c-0c46-4de3-bedc-28806d7c7f68.png" // Ny bild för Hjalmar
}, {
  id: 2,
  name: "Ellen Bobeck",
  ...
  image: "/lovable-uploads/fadc0cc9-7461-4cdb-9957-078caca49b1b.png" // Ny bild för Ellen
}, {
  id: 3,
  ...
  image: "/lovable-uploads/e9bbaf53-f37e-4d94-898b-b113f45c448c.png" // Ny bild för David
}];
const About = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
